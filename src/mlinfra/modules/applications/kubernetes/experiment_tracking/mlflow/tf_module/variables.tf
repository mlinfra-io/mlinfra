...
variable "remote_tracking" {
  type        = bool
  description = "This variable tracks if the mlflow is deployed with an external metadata tracker and blob storage"
  default     = false
}

variable "mlflow_data_bucket_name" {
  type        = string
  description = ""
...
variable "mlflow_secret" {
  type        = string
  description = "The name of the secret containing the mlflow credentials"
  default     = "mlflow-db-auth"
}
